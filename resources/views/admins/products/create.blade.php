    ...
    <div class="container-fluid px-4">
        ...
        <form action="{{ route('admins.products.store') }}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input id="content" name="content" type="text" class="form-control" value="{{ old('content') }}" placeholder="請輸入商品內容">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="quantity" name="quantity" type="text" class="form-control" value="{{ old('quantity') }}" placeholder="請輸入商品數量">
            </div>
