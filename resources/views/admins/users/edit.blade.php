...
@section('page-content')
    <div class="container-fluid px-4">
        ...
        <form action="{{ route('admins.users.update',$user->id) }}" method="POST" role="form">
            ...
            <div class="form-group">
                <label for="bank_branch" class="form-label">銀行代號</label>
                <input id="bank_branch" name="bank_branch" type="text" class="form-control" value="{{ old('bank_branch',$user->bank_branch) }}" placeholder="選填">
            </div>
            <div class="form-group">
                <label for="bank_account" class="form-label">銀行帳號</label>
                <input id="bank_account" name="bank_account" type="text" class="form-control" value="{{ old('bank_account',$user->bank_account) }}" placeholder="選填">
            </div>
